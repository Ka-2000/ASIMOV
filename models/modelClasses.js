...
const Classes = {
    ...
    async afficherVilles(){

        let requeteSQL = "SELECT * FROM commune"
    ...
    async afficherEmployes(){

        let requeteSQL = "SELECT * FROM employe"
    ...
    async validerMission(req){ 
        ...
        let requeteSQL = "UPDATE mission SET mission_Validation = True WHERE mission_Id = ?"
